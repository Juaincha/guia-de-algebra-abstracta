...
De este modo, con $n=-1$, obtenemos $a^{-1+1}=a·a^{-1}$, $\boxed{a^0=e}$. Con estas propiedades básica es suficiente para poder trabajar con grupos. Desde el próximo capítulo en adelante se verán ejemplos importantes para aplicar las propiedades que hemos aprendido hasta ahora.
