...
><br>
>2. Sea $A$ un conjunto no vacío, y $P=\{A_1,A_2,...A_n\}$ una partición del conjunto. Definimos: para todo $x,y \in A$ $x\sim_P y \iff$ existe un $A_i \in P$ tal que $x \in A_i, y \in A_i$.<br>
