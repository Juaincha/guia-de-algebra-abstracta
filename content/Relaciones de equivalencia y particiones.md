...
>[!definicion] Definición de partición
...
>[!demostracion] Demostración
>1. Sea $A$ un conjunto no vacío, y $\sim$ una relación de equivalencia en el conjunto. Definimos: para todo $x\in A$, $[x]\coloneqq \{y\in A |\ x \sim y \}$. Sea $P_\sim=\{[x]\ |\ x \in A \}$. <br>
